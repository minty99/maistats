...
const translations = defineTranslations({
  ko: {
    ...
    'tiers.heading': 'User Tier Charts',
    'tiers.description': 'Raveille user tier와 Lomo tier mapping을 기준으로 구성한 목록입니다.',
    'tiers.filters': '필터',
    'tiers.hideNoData': '플레이 기록 없는 곡 숨기기',
    'tiers.hideBelow90': '90% 미만 숨기기',
    'tiers.showPlot': 'Plot 보기',
    'tiers.hidePlot': 'Plot 숨기기',
    'tiers.plotTitle': 'User Tier Plot',
    'tiers.plotDescription': '최근 90일 내 플레이한 90% 이상 기록을 user tier와 달성률 기준으로 표시합니다. x축은 13.00~14.50으로 고정됩니다.',
    'tiers.plotEmpty': '13.00~14.50 범위에 표시할 tier 기록이 없습니다.',
    ...
    'picker.songInfoRequired': 'Song Database URL이 비어 있습니다.',
    ...
    'plot.description': '선택한 레벨 범위의 곡 중 최근 3개월 내 플레이한 곡(달성률 90% 이상)의 분포를 표시합니다.',
    'plot.invalidRange': '유효한 레벨 범위를 입력하세요 (1.0~15.0).',
  ...
  en: {
    ...
    'tiers.heading': 'User Tier Charts',
    'tiers.description': 'This list is built from Raveille user tiers and Lomo tier mapping.',
    'tiers.filters': 'Filters',
    'tiers.hideNoData': 'Hide charts without play records',
    'tiers.hideBelow90': 'Hide below 90%',
    'tiers.showPlot': 'Show plot',
    'tiers.hidePlot': 'Hide plot',
    'tiers.plotTitle': 'User Tier Plot',
    'tiers.plotDescription': 'Plots records played in the last 90 days with achievement >= 90% by user tier and achievement. The x-axis is fixed to 13.00-14.50.',
    'tiers.plotEmpty': 'No tier records are available in the 13.00-14.50 range.',
    ...
    'picker.chooseVersions': 'Choose versions',
    'picker.lastPlayedDays': 'Last played (days)',
    'picker.songInfoRequired': 'Song Database URL is empty.',
    ...
    'picker.statusReady': 'Ready',
    'plot.title': 'Score Distribution',
    'plot.description': 'Shows the distribution of songs played in the last 3 months (achievement >= 90%) for the selected level range.',
    'plot.invalidRange': 'Enter a valid level range (1.0\u201315.0).',

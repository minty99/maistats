...
const translations = defineTranslations({
  ko: {
    ...
    'tiers.title': 'USER TIERS',
    'tiers.heading': 'User Tier Charts',
    'tiers.description': 'Raveille user tier와 Lomo tier mapping을 기준으로 구성한 목록입니다.',
    'tiers.coverage': 'Played charts',
    'tiers.coverageHelp': 'tier 목록 중 기록이 있는 채보 수',
    'tiers.range': 'Tier range',
    'tiers.rangeHelp': '아래가 낮고 위가 높은 순서',
    'tiers.hideNoData': 'No Data 숨기기',
    'tiers.empty': 'User tier 데이터를 찾지 못했습니다. Song Database가 raveille_user_tier.json을 제공하는지 확인하세요.',
    'tiers.emptyAfterFilter': 'No Data를 숨긴 뒤 표시할 기록이 없습니다.',
  ...
  en: {
    ...
    'tiers.coverage': 'Played charts',
    'tiers.coverageHelp': 'Charts with records in the tier list',
    'tiers.range': 'Tier range',
    'tiers.rangeHelp': 'Lowest at the bottom, highest at the top',
    'tiers.hideNoData': 'Hide No Data',
    'tiers.empty': 'No user tier data is available. Check that the Song Database serves raveille_user_tier.json.',
    'tiers.emptyAfterFilter': 'No records remain after hiding No Data charts.',
    'picker.filterSettings': 'Filter Settings',

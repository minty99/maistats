...
const translations = defineTranslations({
  ko: {
    ...
    'plot.userTierDescription': '같은 기간 안에 플레이한 90% 이상 기록을 user tier와 달성률 기준으로 표시합니다. x축은 13.00~14.50으로 고정됩니다.',
    'plot.userTierEmpty': '13.00~14.50 범위에 표시할 tier 기록이 없습니다.',
  ...
  en: {
    ...
    'plot.userTierTitle': 'User Tier Distribution',
    'plot.userTierDescription': 'Plots records played within the same period with achievement >= 90% by user tier and achievement. The x-axis is fixed to 13.00-14.50.',
    'plot.userTierEmpty': 'No tier records are available in the 13.00-14.50 range.',
    'songDetail.title': 'Song Detail',

...
const translations = defineTranslations({
  ko: {
    ...
    'scores.noCollectorNotice': '개인 기록 수집 서버 URL이 없어 개인 기록은 없는 상태로 표시합니다. Song Database의 곡/채보 정보만 확인할 수 있습니다.',
    'scores.versionAll': 'ALL',
    'scores.versionNew': 'NEW',
    'scores.versionOld': 'OLD',
    'compare.title': 'Compare',
    'compare.description': '내 기록과 라이벌 기록의 달성률 차이를 비교합니다.',
    'compare.connectTitle': '라이벌 기록 수집 서버',
    'compare.connectDescription': '비교할 라이벌의 Record Collector URL을 입력하세요.',
    'compare.opponentUrl': '라이벌 서버 URL',
    'compare.connectedOpponent': '라이벌 연결됨: {{name}}',
    'compare.loadFailed': '라이벌 기록을 불러오지 못했습니다: {{message}}',
    'compare.loading': '비교 기록 불러오는 중...',
    'compare.myRecord': '본인기록',
    'compare.opponentRecord': '라이벌기록',
    'compare.opponentOnly': '라이벌만 플레이한 곡만 표시',
    'compare.bothPlayedOnly': '둘 모두 플레이한 곡만 표시',
    ...
    'app.missingUrls': 'Song Database URL이 필요합니다.',
  ...
  en: {
    ...
    'scores.versionOld': 'OLD',
    'compare.title': 'Compare',
    'compare.description': "Compare achievement differences between your records and your rival's records.",
    'compare.connectTitle': 'Rival Record Collector',
    'compare.connectDescription': "Enter your rival's Record Collector URL.",
    'compare.opponentUrl': 'Rival server URL',
    'compare.connectedOpponent': 'Rival connected: {{name}}',
    'compare.loadFailed': 'Failed to load rival records: {{message}}',
    'compare.loading': 'Loading comparison records...',
    'compare.myRecord': 'My Record',
    'compare.opponentRecord': 'Rival Record',
    'compare.opponentOnly': 'Only songs played by rival',
    'compare.bothPlayedOnly': 'Only songs played by both',

...
const translations = defineTranslations({
  ko: {
    ...
    'compare.rivalUrl': '라이벌 서버 URL',
    'compare.connectedRival': '라이벌 연결됨: {{name}}',
    'compare.loadFailed': '라이벌 기록을 불러오지 못했습니다: {{message}}',
    'compare.loading': '비교 기록 불러오는 중...',
    'compare.myRecord': '본인기록',
    'compare.rivalRecord': '라이벌기록',
    'compare.rivalOnly': '라이벌만 플레이한 곡만 표시',
  ...
  en: {
    ...
    'compare.rivalUrl': 'Rival server URL',
    'compare.connectedRival': 'Rival connected: {{name}}',
    ...
    'compare.rivalRecord': 'Rival Record',
    'compare.rivalOnly': 'Only songs played by rival',

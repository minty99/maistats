...
const translations = defineTranslations({
  ko: {
    ...
    'compare.description': '내 기록과 상대 기록의 달성률 차이를 비교합니다.',
    'compare.connectTitle': '상대 기록 수집 서버',
    'compare.connectDescription': '비교할 유저의 Record Collector URL을 입력하세요.',
    'compare.opponentUrl': '상대 서버 URL',
    'compare.connectedOpponent': '상대 연결됨: {{name}}',
    'compare.loadFailed': '상대 기록을 불러오지 못했습니다: {{message}}',
    'compare.loading': '비교 기록 불러오는 중...',
    'compare.myRecord': '본인기록',
    'compare.opponentRecord': '상대기록',
  ...
  en: {
    ...
    'scores.versionOld': 'OLD',
    'compare.title': 'Compare',
    'compare.description': 'Compare achievement differences between your records and another player.',
    'compare.connectTitle': 'Opponent Record Collector',
    'compare.connectDescription': "Enter the other user's Record Collector URL.",
    'compare.opponentUrl': 'Opponent server URL',
    'compare.connectedOpponent': 'Opponent connected: {{name}}',
    'compare.loadFailed': 'Failed to load opponent records: {{message}}',
    'compare.loading': 'Loading comparison records...',
    'compare.myRecord': 'My Record',
    'compare.opponentRecord': 'Opponent Record',
